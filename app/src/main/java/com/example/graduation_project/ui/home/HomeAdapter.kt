...
class HomeAdapter(val homeListItem: ArrayList<HomeModel>): RecyclerView.Adapter<HomeAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):ViewHolder {
        ...
        return ViewHolder(v).apply {
            ...
            itemView.setOnClickListener {
                    ...
                    intent.putExtra("language_img",this@HomeAdapter.homeListItem.get(curPos).language_img)
                    intent.putExtra("tag",this@HomeAdapter.homeListItem.get(curPos).tag)
                    intent.putExtra("info",this@HomeAdapter.homeListItem.get(curPos).date+" : " +this@HomeAdapter.homeListItem.get(curPos).saved+" Saved")
    ...
    class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView){
        ...
        fun bindItems(model: HomeModel) {
            ...
            itemView.home_cardview_status_txt.text = model.date +" : "+ model.saved.toString()+" Saved"
